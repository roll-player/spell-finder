...
var isDarkMode = args.indexOf('--dark') !== -1 || process.env.dark;
var defaultColor = isDarkMode ? _chalk2.default.black : _chalk2.default.white;

var renderLine = function renderLine(label, value) {
  return console.log(defaultColor.underline(label) + '\r\n\t' + defaultColor.bold(value));
};
...
var diceReplacer = function diceReplacer(match) {
  return isDarkMode ? _chalk2.default.blue.bold(match) : _chalk2.default.yellow.bold(match);
};
